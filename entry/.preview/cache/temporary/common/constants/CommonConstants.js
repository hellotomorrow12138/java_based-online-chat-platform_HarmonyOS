...
// 设备列数定义
CommonConstants.GRID_ROW_SM = 4; // SM设备
CommonConstants.GRID_ROW_MD = 8; // MD设备
CommonConstants.GRID_ROW_LG = 12; // LG设备
// 间距定义
CommonConstants.GUTTER_X = vp2px(12); // x方向设备檐沟
// 页面跨度定义
CommonConstants.SPAN_SM = 4; // SM设备
CommonConstants.SPAN_MD = 6; // MD设备
CommonConstants.SPAN_LG = 8; // LG设备
// 隐私声明跨度
CommonConstants.PRIVACY_SPAN_SM = 2; // SM设备
CommonConstants.PRIVACY_SPAN_MD = 4; // MD设备
CommonConstants.PRIVACY_SPAN_LG = 4; // LG设备
// “我的”页面跨度
CommonConstants.MINE_SPAN_SM = 4; // SM设备
CommonConstants.MINE_SPAN_MD = 8; // MD设备
CommonConstants.MINE_SPAN_LG = 8; // LG设备
// 登录按钮跨度
CommonConstants.BUTTON_SPAN_SM = 4; // SM设备
CommonConstants.BUTTON_SPAN_MD_SMALL = 3; // MD设备（小断点）
CommonConstants.BUTTON_SPAN_MD_BIG = 6; // MD设备（大断点）
CommonConstants.BUTTON_SPAN_LG = 8; // LG设备
// 偏移量定义
CommonConstants.OFFSET_SM = 1; // SM设备
CommonConstants.OFFSET_MD = 1; // MD设备
CommonConstants.OFFSET_LG = 2; // LG设备
CommonConstants.PRIVACY_OFFSET_SM = 1; // 隐私声明 SM设备
CommonConstants.PRIVACY_OFFSET_MD = 2; // 隐私声明 MD设备
CommonConstants.PRIVACY_OFFSET_LG = 4; // 隐私声明 LG设备
CommonConstants.BUTTON_OFFSET_SM = 0; // 登录按钮 SM设备
CommonConstants.BUTTON_OFFSET_MD = 2; // 登录按钮 MD设备
CommonConstants.BUTTON_OFFSET_LG = 4; // 登录按钮 LG设备
// 断点设置
...
CommonConstants.TAB_ITEM_FONT_WEIGHT = 500;
CommonConstants.FULL_HEIGHT_PERCENT = '100%';
