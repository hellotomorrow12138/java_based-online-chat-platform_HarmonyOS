...
class Chat extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Navigation.create();
            Navigation.debugLine("pages/Chat.ets(47:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/Chat.ets(48:7)");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/Chat.ets(49:9)");
            Column.width("100%");
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/Chat.ets(50:11)");
            List.width("100%");
            List.height("100%");
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("pages/Chat.ets(52:15)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            // 简化显示逻辑，不区分发送者和接收者样式
                            Row.create();
                            Row.debugLine("pages/Chat.ets(54:17)");
                            if (!isInitialRender) {
                                // 简化显示逻辑，不区分发送者和接收者样式
                                Row.pop();
                            }
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("pages/Chat.ets(55:19)");
                            if (!isInitialRender) {
                                Text.pop();
                            }
                            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/Chat.ets(62:9)");
            Row.width("100%");
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("pages/Chat.ets(63:11)");
            TextInput.width("80%");
            TextInput.height(50);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Chat.ets(69:11)");
            Button.height(50);
            Button.width(70);
            Button.onClick(() => {
                this.sendData();
