...
class MinePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            SideBarContainer.debugLine("pages/MinePage.ets(24:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MinePage.ets(25:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Column.create();
                    Column.debugLine("pages/MinePage.ets(27:11)");
                    Column.onClick(() => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create(this.current === item.index ? { "id": 16777329, "type": 20000, params: [], "bundleName": "com.example.index_test1", "moduleName": "entry" } : this.normalIcon);
                    Image.debugLine("pages/MinePage.ets(28:13)");
                    Image.width(64);
                    Image.height(64);
                    if (!isInitialRender) {
                        Image.pop();
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("pages/MinePage.ets(29:13)");
                    Text.fontSize(25);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MinePage.ets(43:7)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Scroll.create();
            Scroll.debugLine("pages/MinePage.ets(45:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridRow.debugLine("pages/MinePage.ets(46:11)");
            GridRow.margin({
                left: '12vp',
                right: '12vp'
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("pages/MinePage.ets(55:13)");
            if (!isInitialRender) {
                GridCol.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MinePage.ets(65:15)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777246, "type": 20000, params: [], "bundleName": "com.example.index_test1", "moduleName": "entry" });
            Image.debugLine("pages/MinePage.ets(66:17)");
            Image.width('56vp');
            Image.height('56vp');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/MinePage.ets(70:17)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(`您已登录`);
            Text.debugLine("pages/MinePage.ets(75:17)");
            Text.textAlign(TextAlign.Center);
            Text.fontWeight(CommonConstants.NICKNAME_FONT_WEIGHT);
            Text.fontSize('20vp');
            Text.margin({ top: '12vp' });
